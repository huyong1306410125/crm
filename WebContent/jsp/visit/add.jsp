...
<body >
	<b>当前位置：客户拜访 &gt; 新增客户拜访 </b>

	<br />
	<hr />


	<form class="form-inline" action="${pageContext.request.contextPath }/VisitAction_addVisit.action" method="post">
		<table align="center">
			<tr>
				<td>
					...
					<div class="input-group">
						...
						<select class="form-control" name="visitUser.uid">
							<c:forEach items="${userList}" var="user">
								<option value="${user.uid}">${user.nikeName}</option>
							</c:forEach>
						</select>
					</div>
				</td>
				...
				<td>
					<div class="form-group">
						<label>拜访地址:</label> <input type="text" class="form-control"
							name="visitAddress" placeholder="拜访地址">
					</div>
				</td>
				<td>
					<div class="form-group">
						<label>拜访内容:</label> <input type="text" class=" form-control"
							name="visitConent" placeholder="拜访内容">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="form-group">
						<label>拜访时间:</label> <input type="text" class="form-control form-date "
							name="visitTime" placeholder="拜访时间">
					</div>
				</td>
			</tr>
			<tr>
