...
<body >
	...
	<form class="form-inline" action="${pageContext.request.contextPath }/LinkManAction_updateLinkMan" method="post">
					...
					<div class="input-group">
						...
						<select class="form-control" name="customer.cid">
							<c:forEach items="${customerList}" var="customer">
								<option value="${customer.cid}" <c:if test="${customer.cid eq linkMan.customer.cid}">selected</c:if>>${customer.cname}</option>
							</c:forEach>
						</select>
					</div>
				</td>
				...
				<td>
					<div class="form-group">
						<label>联系人姓名:</label> <input type="text" class="form-control"
							name="lname" value="${linkMan.lname }">
					</div>
				</td>
				<td>
					<div class="form-group">
						<label>联系人性别:</label> <input type="text" class="form-control"
							name="lgender" value="${linkMan.lgender }">
					</div>
				</td>
			</tr>
			<tr>
				<td>
					<div class="form-group">
						<label>联系人电话:</label> <input type="text" class="form-control"
							name="lphone" value="${linkMan.lphone }">
					</div>
				</td>
				<td>
					<div class="form-group">
						<label>联系人地址:</label> <input type="text" class="form-control"
							name="laddress" value="${linkMan.laddress }">
					</div>
				</td>
			</tr>
			<tr>
