...
<body>
	...
	<ul class="pager pager-pills" >
		...
		<li class="previous <s:if test="pageBean.currentPage == 1">disabled</s:if>"><a href="${pageContext.request.contextPath }/CustomerAction_findCustomerByPage.action?currentPage=<s:property value="pageBean.currentPage -1"/>">上一页</a></li>
		
			<s:iterator begin="1" end="pageBean.totalPage" var="i">
			<s:if test="#i != pageBean.currentPage">
				<li><a href="${pageContext.request.contextPath }/CustomerAction_findCustomerByPage.action?currentPage=<s:property value="#i"/>"><s:property value="#i"/></a></li>
			</s:if>
		...
		<li class="next <s:if test=" pageBean.currentPage == pageBean.totalPage">disabled</s:if>"><a href="${pageContext.request.contextPath }/CustomerAction_findCustomerByPage.action?currentPage=<s:property value="pageBean.currentPage +1"/>">下一页</a></li>
